...
const message = `A total of $${totalmoney.toLocaleString('en-US')} has been raised for ${fundedGames.length} game${fundedGames.length > 1 ? 's' : ''}. Currently, ${unfundedGames.length} game${unfundedGames.length > 1 ? 's' : ''} remain unfunded. We need your help to fund these amazing games!`
...
nameElement1.innerHTML = topGame.name
firstGameContainer.appendChild(nameElement1)

const nameElement2 = document.createElement('p')
nameElement2.innerHTML = secondGame.name
secondGameContainer.appendChild(nameElement2)
